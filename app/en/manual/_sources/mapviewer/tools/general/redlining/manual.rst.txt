Using the Drawing (Redlining) Tool
=======================================

General Usage
--------------------

The drawing (redlining) tool is actually a collection of (sub-)tools that make it possible
to graphically augment the content of the map.
After opening the tool, the drawing (redlining) dialog is shown.
...
.. note::
   Deletion is permanent. The drawing (redlining) tool does not offer an **undo**!
