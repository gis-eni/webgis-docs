...
In diesem Abschnitt werden weitere Konzepte des Zeichnen (Map-Markup) Werkzeugs behandelt:
...
.. note::
   ...
   "alte" Zeichnungen von Zeit zu Zeit zu löschen, da mit dem Map-Markup Werkzeug eigentlich nur temporäre 
   Zeichnungen erstellt werden sollten (siehe Beschreibung "gute Anwendungsfälle für Map-Markup").
...
nur vom Map-Markup Werkzeug beim späteren Hochladen wieder interpretiert werden kann.
...
Es können *GPX* und *GeoJson* (Map-Markup Projekte, die früher heruntergeladen wurden) Dateien hochgeladen werden.
